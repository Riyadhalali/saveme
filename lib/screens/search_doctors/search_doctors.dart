...
class SearchResults extends StatefulWidget {
  ...
  SearchResults({this.textToSearch});
...
class _SearchResultsState extends State<SearchResults> {
  ...
  Stream<List<DoctorPosts>> searchResults() => FirebaseFirestore.instance
      .collection('posts')
      // .where('doctorPhone', isEqualTo: widget.textToSearch)
      // .where('doctorName', isEqualTo: widget.textToSearch)
      .where('doctorType', isEqualTo: widget.textToSearch)
      //.where('openingTime', isEqualTo: widget.textToSearch)
      //   .where('doctorEmail', isEqualTo: widget.textToSearch)
      //  .where('doctorLocation', isEqualTo: widget.textToSearch)
      .snapshots()
